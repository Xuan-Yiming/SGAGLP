...
//        int[] depotCoordinates = new int[]{depot.getX(), depot.getY()};
        ...
        totalDistance += Euclidian.distance(depot.getId(), toCustomer.getId(), this.manager);
...
//            int[] fromCustomerCoordinates = new int[]{fromCustomer.getX(), fromCustomer.getY()};
            ...
            totalDistance += Euclidian.distance(fromCustomer.getId(), toCustomer.getId(), this.manager);
            fromCustomer = toCustomer;
        }
        totalDemand += fromCustomer.getDemand();

        // Add distance from last customer and back to depot
        totalDistance += Euclidian.distance(toCustomer.getId(), depot.getId(), this.manager);
