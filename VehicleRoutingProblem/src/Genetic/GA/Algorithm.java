...
public class Algorithm {
    ...
    private final Genetic.GA.Operations.Mutation mutation;
    private final int populationSize;
    private final int numberOfGenerations;
    private final double fitnessGoal;
    private final int refinementAfter;
    private final double crossoverRateRefinementMode;
    private final double fitnessBias;
    private final int eliteReplacement;
    ...
    public Algorithm(Manager manager) {
        ...
        this.obstacles = manager.getObstacles();
