...
class TestDeshabilitarEspecialidad():
  def setUp(self):
  ...
  def test_deshabilitarEspecialidad(self):
    driver = self.driver
    ...
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".btnEliminarGM").click()
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".botonAceptarGM").click()
