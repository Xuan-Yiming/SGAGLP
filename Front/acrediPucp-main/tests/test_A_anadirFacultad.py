...
class TestAnadirFacultad():
  ...
  def test_anadirFacultad(self):
    ...
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".nav-item:nth-child(2) .opcionRBB").click()
    time.sleep(1)
    ...
    time.sleep(1)
    driver.find_element(By.NAME, "codigo").click()
    element = self.driver.find_element(By.NAME, "codigo")
    ...
    time.sleep(1)
    driver.find_element(By.NAME, "evidencia").send_keys("pruebapruebaprueba")
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".btnAniadirAAF").click()
    time.sleep(1)
    driver.execute_script("window.scrollTo(0,0)")
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".table-row:nth-child(2) > td:nth-child(2) > .seleccionableGC").click()
    time.sleep(1)
    ...
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".selected > td:nth-child(1)").click()
    time.sleep(1)
    ...
    driver.execute_script("window.scrollTo(0,0)")
    time.sleep(1)
    driver.find_element(By.ID, "7").click()
    time.sleep(1)
    ...
    driver.find_element(By.CSS_SELECTOR, ".botonAceptarAARF").click()
    driver.find_element(By.CSS_SELECTOR, ".btnGuardarAAF").click()
