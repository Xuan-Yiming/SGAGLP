...
class TestVerDetalleEspecialidad():
  def setUp(self):
  ...
  def test_verDetalleEspecialidad(self):
    driver = self.driver
    ...
    time.sleep(1)
    driver.find_element(By.CSS_SELECTOR, ".table-row:nth-child(1) > td:nth-child(3) > .seleccionableGM").click()
    time.sleep(1)
