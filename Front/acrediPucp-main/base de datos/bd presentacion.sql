...
--
-- Host: acredipucpPresentacionFinal-limpia.cw5k214min6e.us-east-1.rds.amazonaws.com    Database: acredipucpPresentacionFinal
-- ------------------------------------------------------
...
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `actualizarEstadoActividad` BEFORE UPDATE ON `Actividad` FOR EACH ROW BEGIN
    ...
    END IF;
     IF OLD.fidEstado = 3 AND NEW.fidEstado = 1 THEN
        SET NEW.fechaFin = null;
        SET NEW.fechaInicio = null;
    END IF;
     IF OLD.fidEstado = 1 AND NEW.fidEstado = 3 THEN
        SET NEW.fechaFin =SYSDATE();
        SET NEW.fechaInicio = SYSDATE();
    END IF;
END */;;
...
CREATE TABLE `Logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45970 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'acredipucpPresentacionFinal'
--

--
-- Dumping routines for database 'acredipucpPresentacionFinal'
--
...
BEGIN
	...
	UPDATE Medicion SET codigo=concat('MED ',_idMedicion) WHERE idMedicion=_idMedicion;
    ...
    END WHILE;
     ...
     select concat('MED ',_idMedicion) as dato;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
begin
    ...
    usuarioAnulacion = _usuarioAnulacion2, fechaAnulacion = now()
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `correoCodigo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `correoCodigo`(
	in _cod varchar(20),
    out _correo varchar(200)
)
begin
	select correo into _correo from Usuario where codigoPUCP=_cod;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	declare tempCXM INT;
	declare idDCXM INT;
	declare tempDCXM INT;
	
    declare es_activada INT;
    
    declare _usuarioCreacion VARCHAR(100);
    
	
    SELECT count(*) INTO C FROM Medicion WHERE codigo = _codigo and fidEspecialidad = _fidEspecialidad and activo = 1;
    #set es_activada = (SELECT activo FROM Medicion WHERE codigo = _codigo and fidEspecialidad = _fidEspecialidad);
	SET MSG0 = CONCAT('Ya existe una medicion registrada con codigo ', _codigo, '.');
    
    IF (C != 0) THEN    
		SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = MSG0;
		#IF (es_activada = 0) THEN
			#SET MSG0 = CONCAT('Ya existe una medicion registrada con codigo ', _codigo, ', esta desactivada.');
		#END IF;
		#SIGNAL SQLSTATE '45000'
            #SET MESSAGE_TEXT = MSG0;
	END IF;
    
    SELECT MAX(idMedicion) into _nuevoIdMedicion FROM Medicion LIMIT 1;
    SET _codigo = concat('MED ', _nuevoIdMedicion+1);
    ...
    SET _nuevoCodigo = _codigo;
	
	drop table if exists tmp_DetalleCompetenciaXMuestra;
	...
	drop table if exists tmp_EspacioXIndicador;
	...
	CREATE TABLE `tmp_EspacioXIndicador` (
		`idEspacioXIndicador` int NOT NULL AUTO_INCREMENT,
		`fidIndicador` int NOT NULL,
		`fidEspacioMedicion` int NOT NULL,
		`UsuarioCreacion` varchar(100) DEFAULT NULL,
		...
		PRIMARY KEY (`idEspacioXIndicador`),
		KEY `fk_espacio_indxesp_idx` (`fidEspacioMedicion`),
		CONSTRAINT `fk_espacio_indxesp_tmp` FOREIGN KEY (`fidEspacioMedicion`) REFERENCES `tmp_EspacioMedicion` (`idEspacioMedicion`) ON UPDATE CASCADE
	) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
    ...
    CREATE TABLE `tmp_IndicadorXMuestra` (
		...
		PRIMARY KEY (`idIndicadorXMuestraMedicion`),
		KEY `FK_IndicadorEspacioXMuestraMedicion_MuestraMedicion_idx` (`fidMuestraMedicion`),
		CONSTRAINT `FK_IndicadorEspacioXMuestraMedicion_MuestraMedicion_tmp` FOREIGN KEY (`fidMuestraMedicion`) REFERENCES `tmp_MuestraMedicion` (`idMuestraMedicion`) ON UPDATE CASCADE
	) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
    CREATE TABLE `tmp_CompetenciaXMuestra` (
		...
		PRIMARY KEY (`idCompetenciaXMuestra`),
		KEY `fk_CompetenciaXMuestra_MuestraMedicion1_idx` (`fidMuestraMedicion`),
		CONSTRAINT `fk_CompetenciaXMuestra_MuestraMedicion1_tmp` FOREIGN KEY (`fidMuestraMedicion`) REFERENCES `tmp_MuestraMedicion` (`idMuestraMedicion`) ON UPDATE CASCADE
	) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
	CREATE TABLE `tmp_DetalleCompetenciaXMuestra` (
		`idDetalleCompetenciaXMuestra` int NOT NULL AUTO_INCREMENT,
		`fidCompetenciaXMuestra` int NOT NULL,
		`rutaEvidencia` varchar(400) DEFAULT NULL,
		`activo` tinyint NOT NULL,
		PRIMARY KEY (`idDetalleCompetenciaXMuestra`),
		KEY `FK_DETALLECOMPETENCIAMUESTRA_COMPETENCIAMUESTRA_idx` (`fidCompetenciaXMuestra`),
		CONSTRAINT `FK_DETALLECOMPETENCIAMUESTRA_COMPETENCIAMUESTRA_tmp` FOREIGN KEY (`fidCompetenciaXMuestra`) REFERENCES `tmp_CompetenciaXMuestra` (`idCompetenciaXMuestra`) ON UPDATE CASCADE
	) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
	...
	INSERT INTO tmp_EspacioXIndicador ( idEspacioXIndicador, fidIndicador, fidEspacioMedicion, UsuarioCreacion, FechaCreacion, activo, evidencia)
	SELECT                             idEspacioXIndicador, fidIndicador, fidEspacioMedicion, _usuarioCreacion, now()        , activo, evidencia
	FROM EspacioXIndicador WHERE fidEspacioMedicion IN ( SELECT idEspacioMedicion FROM tmp_EspacioMedicion);
    ...
    SELECT                             idIndicadorXMuestraMedicion, fidIndicador, fidMuestraMedicion, posicionResultado, 0              , 0       , 0         , 0               , 0            , _usuarioCreacion, now()      , activo, evidencia, fidParametroEnviado
	...
	INSERT INTO tmp_DetalleCompetenciaXMuestra (idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo)
	SELECT 										idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo
	FROM DetalleCompetenciaXMuestra WHERE fidCompetenciaXMuestra IN ( SELECT idCompetenciaXMuestra FROM tmp_CompetenciaXMuestra);

	
	SET idEM = (SELECT MAX(idEspacioMedicion) FROM EspacioMedicion);
	SET tempEM = (SELECT MIN(idEspacioMedicion) FROM tmp_EspacioMedicion);
	SET idEI = (SELECT MAX(idEspacioXIndicador) FROM EspacioXIndicador);
	SET tempEI = (SELECT MIN(idEspacioXIndicador) FROM tmp_EspacioXIndicador);
	SET idMM = (SELECT MAX(idMuestraMedicion) FROM MuestraMedicion);
	SET tempMM = (SELECT MIN(idMuestraMedicion) FROM tmp_MuestraMedicion);
	SET idP = (SELECT MAX(idPerfil) FROM Perfil);
	SET tempP = (SELECT MIN(idPerfil) FROM tmp_Perfil);
	SET idIXM = (SELECT MAX(idIndicadorXMuestraMedicion) FROM IndicadorXMuestra);
	SET tempIXM = (SELECT MIN(idIndicadorXMuestraMedicion) FROM tmp_IndicadorXMuestra);
	SET idCXM = (SELECT MAX(idCompetenciaXMuestra) FROM CompetenciaXMuestra);
	SET tempCXM = (SELECT MIN(idCompetenciaXMuestra) FROM tmp_CompetenciaXMuestra);
	SET idDCXM = (SELECT MAX(idDetalleCompetenciaXMuestra) FROM DetalleCompetenciaXMuestra);
	SET tempDCXM = (SELECT MIN(idDetalleCompetenciaXMuestra) FROM tmp_DetalleCompetenciaXMuestra);

	UPDATE tmp_EspacioMedicion SET idEspacioMedicion = idEspacioMedicion + 8388608 WHERE idEspacioMedicion > -1;
	UPDATE tmp_EspacioXIndicador SET idEspacioXIndicador = idEspacioXIndicador + 8388608 WHERE idEspacioXIndicador > -1;
	UPDATE tmp_MuestraMedicion SET idMuestraMedicion = idMuestraMedicion + 8388608 WHERE idMuestraMedicion > -1;	
	UPDATE tmp_Perfil SET idPerfil = idPerfil + 8388608 WHERE idPerfil > -1;
	UPDATE tmp_IndicadorXMuestra SET idIndicadorXMuestraMedicion = idIndicadorXMuestraMedicion + 8388608 WHERE idIndicadorXMuestraMedicion > -1;
	UPDATE tmp_CompetenciaXMuestra SET idCompetenciaXMuestra = idCompetenciaXMuestra + 8388608 WHERE idCompetenciaXMuestra > -1;
	UPDATE tmp_DetalleCompetenciaXMuestra SET idDetalleCompetenciaXMuestra = idDetalleCompetenciaXMuestra + 8388608 WHERE idDetalleCompetenciaXMuestra > -1;
    
    ###
    
    SELECT idEM, idEI, idMM, idP, idIXM, idCXM, idDCXM, tempEM, tempEI, tempMM, tempP, tempIXM, tempCXM, tempDCXM;
	
	UPDATE tmp_EspacioMedicion SET idEspacioMedicion = idEspacioMedicion + idEM - tempEM - 8388607 WHERE idEspacioMedicion > -1;
	UPDATE tmp_EspacioXIndicador SET idEspacioXIndicador = idEspacioXIndicador + idEI - tempEI - 8388607 WHERE idEspacioXIndicador > -1;
	UPDATE tmp_MuestraMedicion SET idMuestraMedicion = idMuestraMedicion + idMM - tempMM - 8388607 WHERE idMuestraMedicion > -1;
	UPDATE tmp_Perfil SET idPerfil = idPerfil + idP - tempP - 8388607 WHERE idPerfil > -1;
	UPDATE tmp_IndicadorXMuestra SET idIndicadorXMuestraMedicion = idIndicadorXMuestraMedicion + idIXM - tempIXM - 8388607 WHERE idIndicadorXMuestraMedicion > -1;
	UPDATE tmp_CompetenciaXMuestra SET idCompetenciaXMuestra = idCompetenciaXMuestra + idCXM - tempCXM - 8388607 WHERE idCompetenciaXMuestra > -1;
	UPDATE tmp_DetalleCompetenciaXMuestra SET idDetalleCompetenciaXMuestra = idDetalleCompetenciaXMuestra + idDCXM - tempDCXM - 8388607 WHERE idDetalleCompetenciaXMuestra > -1;
	...
	INSERT INTO EspacioXIndicador (idEspacioXIndicador, fidIndicador, fidEspacioMedicion, UsuarioCreacion, FechaCreacion, activo, evidencia)
	SELECT idEspacioXIndicador, fidIndicador, fidEspacioMedicion, UsuarioCreacion, FechaCreacion, activo, evidencia
	FROM tmp_EspacioXIndicador;
	...
	INSERT INTO DetalleCompetenciaXMuestra (idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo)
	SELECT idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo
	FROM tmp_DetalleCompetenciaXMuestra;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `DuplicarMedicionIgnoring` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `DuplicarMedicionIgnoring`(
	OUT _nuevoIdMedicion INT,
    OUT _nuevoCodigo VARCHAR(10),
	IN _idMedicion INT,
    IN _fidEspecialidad INT,
...
BEGIN
    ...
    SET _nuevoCodigo = (SELECT codigo FROM Medicion med where idMedicion = _nuevoIdMedicion);
	...
	INSERT IGNORE INTO EspacioMedicion (idEspacioMedicion, fidMedicion, fidCicloAcademico, codigo, nombreCurso, fechaLimite, tipoMedicion, indicadoresConfigurados, fechaCreacion, usuarioCreacion, activo)
	SELECT idEspacioMedicion, fidMedicion, fidCicloAcademico, codigo, nombreCurso, fechaLimite, tipoMedicion, indicadoresConfigurados, fechaCreacion, usuarioCreacion, activo
	FROM tmp_EspacioMedicion;
	
	INSERT IGNORE INTO EspacioXIndicador (idEspacioXIndicador, fidIndicador, fidEspacioMedicion, UsuarioCreacion, FechaCreacion, activo, evidencia)
	SELECT idEspacioXIndicador, fidIndicador, fidEspacioMedicion, UsuarioCreacion, FechaCreacion, activo, evidencia
	FROM tmp_EspacioXIndicador;
	
	INSERT IGNORE INTO MuestraMedicion (idMuestraMedicion, fidEspacioMedicion, codigo, enviado, fechaCreacion, usuarioCreacion, activo)
	SELECT idMuestraMedicion, fidEspacioMedicion, codigo, enviado, fechaCreacion, usuarioCreacion, activo
	FROM tmp_MuestraMedicion;
	
	INSERT IGNORE INTO Perfil (idPerfil, fidUsuario, nivelAcceso, fidMuestra, esAsistente, nombrePerfil, esAdministrador, fechaCreacion, usuarioCreacion, esAuditor, activo)
	SELECT idPerfil, fidUsuario, nivelAcceso, fidMuestra, esAsistente, nombrePerfil, esAdministrador, fechaCreacion, usuarioCreacion, esAuditor, activo
	FROM tmp_Perfil;
	
	INSERT IGNORE INTO IndicadorXMuestra (idIndicadorXMuestraMedicion, fidIndicador, fidMuestraMedicion, posicionResultado, totalResultados, promedio, porcentaje, totalesCumplidos, numeroAlumnos, usuarioCreacion, fechaCreacion, activo, evidencia, fidParametroEnviado)
	SELECT idIndicadorXMuestraMedicion, fidIndicador, fidMuestraMedicion, posicionResultado, totalResultados, promedio, porcentaje, totalesCumplidos, numeroAlumnos, usuarioCreacion, fechaCreacion, activo, evidencia, fidParametroEnviado
	FROM tmp_IndicadorXMuestra;
	
	INSERT IGNORE INTO CompetenciaXMuestra (idCompetenciaXMuestra, fidCompetencia, fidMuestraMedicion, evidenciaEnviada, fidIndicador)
	SELECT idCompetenciaXMuestra, fidCompetencia, fidMuestraMedicion, evidenciaEnviada, fidIndicador
	FROM tmp_CompetenciaXMuestra;
	
	INSERT IGNORE INTO DetalleCompetenciaXMuestra (idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo)
	SELECT idDetalleCompetenciaXMuestra, fidCompetenciaXMuestra, rutaEvidencia, activo
	FROM tmp_DetalleCompetenciaXMuestra;
...
BEGIN
    ...
    WHILE i <= total_rows DO
		...
		UPDATE EspacioXIndicador
        SET activo=0, usuarioAnulacion=_usuario, fechaAnulacion=now() where fidIndicador= _idIndicador and fidEspacioMedicion in (select idEspacioMedicion from temp_Esp where idTemp=i );
        
        UPDATE IndicadorXMuestra
        SET activo=0, usuarioAnulacion=_usuario, fechaAnulacion=now() where fidIndicador= _idIndicador and fidMuestraMedicion in (select idMuestraMedicion from MuestraMedicion where fidEspacioMedicion in (select idEspacioMedicion from temp_Esp where idTemp=i));
		SET i = i + 1;
    END WHILE;
...
BEGIN
    ...
    update IndicadorXMuestra 
    set fidParametroEnviado = _param, usuarioModificacion = _nombreUsuario, fechaModificacion=now()
...
BEGIN
	...
	INSERT INTO acredipucpPresentacionFinal.cicloAcademico (idCicloAcademico, anio, semestre, nombre, fechaInicio, fechaFin, fechaCreacion, usuarioCreacion, activo)
...
BEGIN
    ...
    SELECT count(*) INTO C FROM Competencia WHERE codigoCompetencia = _codigoCompetencia and fidEspecialidad = _fidEspecialidad and activo =1 ;
    IF (C != 0) THEN
        SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = MSG0;
    END IF;
...
BEGIN
    ...
    INSERT INTO acredipucpPresentacionFinal.EspacioMedicion
...
BEGIN
	declare _usuarioCreacion2 VARCHAR(100);
    SET _usuarioCreacion2 = (SELECT concat(nombres,' ',apellidoPaterno) from Usuario where idUsuario=_usuarioCreacion);
    INSERT INTO acredipucpPresentacionFinal.Medicion
...
BEGIN
    ...
    SET _usuarioCreacion2 = (SELECT concat(nombres,' ',apellidoPaterno) from Usuario where idUsuario=_usuarioCreacion);
    INSERT INTO acredipucpPresentacionFinal.MuestraMedicion
    (fidEspacioMedicion, codigo, enviado,fechaCreacion, usuarioCreacion, activo) 
    ...
    SET _idMuestraMedicion = @@last_insert_id;
    sET  @ROW_ID = 0; 
    CALL `acredipucpPresentacionFinal`.`InsertarPerfil`(@ROW_ID, _fidUsuario, _idMuestraMedicion ,0,3, _usuarioCreacion2);
...
BEGIN
    INSERT INTO acredipucpPresentacionFinal.Perfil
...
begin
	select idObjetivoEducacional, sumilla, descripcion,codigoObjetivo, oe.usuarioCreacion as nombreCompleto , oe.fechaCreacion
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ListarCicloAcademicoDupMedicion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `ListarCicloAcademicoDupMedicion`(
	IN _idMedicion INT
)
BEGIN
	DECLARE semestreOG INT;
    DECLARE _mismoCiclo INT;
    SELECT fidCicloFin=fidCicloInicio, (fidCicloInicio%10) INTO _mismoCiclo, semestreOG FROM Medicion WHERE _idMedicion = idMedicion;

	SELECT cic.nombre as ciclo, idcicloAcademico as id, anio, semestre, fechaInicio, fechaFin
    FROM cicloAcademico cic
    where cic.activo=1 and ( _mismoCiclo or ( semestreOG = semestre )) and DATE_FORMAT(now(), '%Y-%m-%d') < cic.fechaFin
    order by cic.nombre;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    and i.idIndicador not in (select fidIndicador from EspacioXIndicador where fidEspacioMedicion in (select idEspacioMedicion from EspacioMedicion where fidMedicion=_idMedicion and EspacioMedicion.activo=1) and EspacioXIndicador.activo=1)
...
BEGIN
	select idMedicion, f.codigoFacultad,f.nombreFacultad ,e.codigoEspecialidad as codigoEspecialidad, e.nombreEspecialidad as nombreEspecialidad, ca1.nombre as cicloInicio, ca2.nombre as cicloFin, codigo as codigoMedicion, Medicion.fechaCreacion, Medicion.usuarioCreacion, Medicion.completada, (Medicion.fidCicloFin=Medicion.fidCicloInicio) as mismoCiclo
	from Medicion
	INNER JOIN Especialidad e ON Medicion.fidEspecialidad = e.idEspecialidad
	INNER JOIN Facultad f ON e.fidFacultad = f.idFacultad
	INNER JOIN cicloAcademico ca1 ON Medicion.fidCicloInicio = ca1.idcicloAcademico
...
BEGIN
    ...
    INNER JOIN Medicion mm ON mm.idMedicion=e.fidMedicion
    WHERE mm.fidEspecialidad = _idEspecialidad and m.activo=1 and m.enviado=1 and mm.activo=1
...
begin
    ...
    SET MSG0 = CONCAT('Ya existe una especialidad registrada con ese codigo.');
	SELECT count(*) into C from Especialidad where codigoEspecialidad = _codigoEspecialidad and idEspecialidad <> _idEspecialidad and fidFacultad = _fidFacultad;
    IF (C != 0) THEN
		SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = MSG0;
	END IF;
    
    SET MSG0 = CONCAT('Ya existe una especialidad registrada con ese codigo en otra facultad.');
	SELECT count(*) into C from Especialidad where codigoEspecialidad = _codigoEspecialidad and idEspecialidad <> _idEspecialidad;
    IF (C != 0) THEN
		SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = MSG0;
	END IF;
...
BEGIN
    ...
    SET MSG0 = CONCAT('Ya existe una facultad registrada con ese codigo.');
    SELECT count(*) into C from Facultad where codigoFacultad = _codigoFacultad and idFacultad <> _idFacultad;
    IF (C != 0) THEN
		SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = MSG0;
	END IF;
...
begin
    ...
    where am.fidMuestraMedicion=_idMuestra and im.fidIndicador=_idIndicador and am.activo = 1 and im.numeroAlumnos!=0
    ORDER BY a.codigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
begin
    ...
    oe.usuarioCreacion AS nombreUsuarioCreacion,
    oe.fechaCreacion,
    oe.usuarioAnulacion AS nombreUsuarioAnulacion,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `VerificarParametrosExistentes` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `VerificarParametrosExistentes`(IN _idEspecialidad INT)
BEGIN
    DECLARE C INT;
    DECLARE MSG0 VARCHAR(200);
    
    SET MSG0 = CONCAT('No hay parámetros configurados para la especialidad.');
	SELECT count(*) into C from Especialidad where idEspecialidad = _idEspecialidad and idNivel is not NULL;
...
-- Dump completed on 2023-07-12 11:36:39
