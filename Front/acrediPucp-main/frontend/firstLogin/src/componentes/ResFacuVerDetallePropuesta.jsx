...
import { addData, addFechaInicio, addFechaFin, addActualizar } from '../Redux/ActividadesSlice';
...
function ResFacuVerDetallePropuesta(props) {
    ...
    const handleButtonFila = async (idEnviado, actividad) => {
        ...
        props.cambiarComponenteVerDetalleActividad(true);
        props.cambiarComponenteVerDetallePropuesta(false);
            ...
            <div className="contenedor-indicadoresREAC">
                ...
                <div className="contIndicREAC">
                    ...
                    <div className="contenedor-botonesREAC" style={{ marginTop: 10 }}>
                        ...
                        <div className="botonesSuperioresREAC" style={{paddingTop:"38px"}}>
...
export default ResFacuVerDetallePropuesta
