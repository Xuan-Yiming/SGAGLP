...
const ModalDrag = ({ closeModal, idCompe, idCod,idInd }) => {
    ...
    return (
        ...
        <>
            <Overlay>
                <ContenedorModal>
                    <EncabezadoModal>
                        <h3>Subir evidencias para el indicador {idCod}</h3>
  ...
  */}
                    ...
                    </div> : <ModalArchivos validar={setValido} close={closeModal} id={idCompe} idI={idInd}/>
                    }
