...
const ModalDragActividades = ({ closeModal, idActividad, idCod }) => {
    ...
    return (
        ...
        <>
            <Overlay>
                <ContenedorModal>
                    <EncabezadoModal>
                        <h3>Subir evidencias para la actividad</h3>
  ...
  */}
                    {valido ? <div>
                        ...
                        <p className='confirmacion'>Sus archivos han sido subidos correctamente</p>
                        <button className="boton-aceptar" onClick={() => closeModal(false)}>Aceptar</button>

                    </div> : <ModalArchivosActividades validar={setValido} close={closeModal} id={idActividad} />
                    }
...
export default ModalDragActividades
