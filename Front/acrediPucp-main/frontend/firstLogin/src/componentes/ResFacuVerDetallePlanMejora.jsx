...
function ResFacuVerDetallePlanMejora(props) {
    ...
    const handleButtonFila = async (idEnviado, propuesta) => {
        ...
        props.cambiarComponenteVerDetallePropuesta(true);
        props.cambiarComponenteVerDetallePlanMejora(false);
...
export default ResFacuVerDetallePlanMejora
