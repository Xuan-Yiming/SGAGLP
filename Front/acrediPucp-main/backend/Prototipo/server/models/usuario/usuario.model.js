                    ...
                    new Promise((resolve, reject) => {
                        ...
                        connection2.query(queryCorreos, function (error, resultados) {
                            ...
                            for (let i = 0; i < resultados.length; i++) {
                                ...
                                var destino= correo 
                                let texto="Bienvenido a AcrediPUCP, puede visitar el sistema en el siguiente enlace: https://reactivos.inf.pucp.edu.pe/"
...
const enviarCorreoBatch = async (correos) => {
    for (let i = 0; i < correos.length; i++) {
      try {
        ...
        const texto = "Bienvenido a AcrediPUCP, puede visitar el sistema en el siguiente enlace: https://reactivos.inf.pucp.edu.pe/";
