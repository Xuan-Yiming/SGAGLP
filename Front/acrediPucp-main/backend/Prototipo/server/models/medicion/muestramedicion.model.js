...
MuestraMedicion.reporteResultadoGeneral = (datos, result) => {
    ...
    var sql = 'call acredipucp.ReporteResultadosGeneral(?,?,?,?);';
    var value = [
        datos.body.periodoI,
        datos.body.periodoF,
        datos.body.codCurso,
...
MuestraMedicion.listarCicloAcademico = (pI, pF, result) => {
    ...
    var sql = 'call acredipucp.ListarCicloAcademico(?,?);';
    var value = [
        pI,
        pF
    ];
...
MuestraMedicion.reporteSeguimientoDeMuestras = (datos, result) => {
    ...
    var sql = 'call acredipucp.ReporteSeguimientoDeMuestras(?,?,?,?);';
    var value = [
...
MuestraMedicion.listarEvidencias = (idCompetencia, idMuestra, idIndicador, result) => {
    ...
    var sql = 'call acredipucp.ListarEvidencias(?,?,?);';
    var value = [
        idCompetencia,
        idMuestra,
        idIndicador
                ...
                if (error) {
                    ...
                    connection.query("SELECT @correo, @texto",  (error, results) => {
                        if (error) {
                            ...
                            var texto = results[0]['@texto'] + ". \n \nEnlace a AcrediPUCP: https://reactivos.inf.pucp.edu.pe/";
