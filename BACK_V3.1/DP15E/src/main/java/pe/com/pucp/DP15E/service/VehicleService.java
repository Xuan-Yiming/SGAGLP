...
public class VehicleService {
    ...
    public  ArrayList<Vehicle> cargaMasivaDeFlotas(MultipartFile file){
        ...
        try(BufferedReader br = new BufferedReader(new InputStreamReader(file.getInputStream()))){
            ...
            while((line=br.readLine())!=null){
                ...
                if(data.length >=2){
                    ...
                    int unidadA=2,unidadB=4,unidadC=4,unidadD=10,idVehiculo;
                    Calendar calendar = Calendar.getInstance();
                    idVehiculo = Integer.parseInt(data[1].substring(2, 4));
                ...
                encontrado = buscarVehicleRepetidos(vehicle,ListaVehicle);
                if(encontrado==0){
            ...
            throw new RuntimeException("Error al cargar el archivo csv: " + e.getMessage());
        }
    }
    ...
    public int buscarVehicleRepetidos(Vehicle abuscar, List<Vehicle> lista){
